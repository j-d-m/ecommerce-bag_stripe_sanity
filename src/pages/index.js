...
//**2.getServerSideProps can only be exported from a PAGE, you
//**cannot export it from non-page files.
//**3.getServerSideProps MUST be exported as a stand alone
//**function. it will not work if you add it as a property on the page component.
